...
public class VersionFilesEntity implements Serializable{
	...
	public VersionFilesEntity(String filename, String address, String location, Integer filetype, Long filesize, Integer isreg, 
			Integer deccompressfile,String versionid,String createtime,String host) {
